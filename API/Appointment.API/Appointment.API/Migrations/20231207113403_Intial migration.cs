    ...
    public partial class Intialmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingId = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    BookingsBookingId = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DoctorsId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingDoctors", x => new { x.BookingsBookingId, x.DoctorsId });
                    table.ForeignKey(
                        name: "FK_BookingDoctors_Bookings_BookingsBookingId",
                        column: x => x.BookingsBookingId,
                        principalTable: "Bookings",
                        principalColumn: "BookingId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingDoctors_Doctors_DoctorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AfterFood = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "MedicalRecordId");
                    table.ForeignKey(
                        name: "FK_Observations_Prescriptions_PrescriptionId",
                        column: x => x.PrescriptionId,
                        principalTable: "Prescriptions",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingUsers", x => new { x.BookingsBookingId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_BookingUsers_Bookings_BookingsBookingId",
                        column: x => x.BookingsBookingId,
                        principalTable: "Bookings",
                        principalColumn: "BookingId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingUsers_Users_UsersId",
                        column: x => x.UsersId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingDoctors_DoctorsId",
                table: "BookingDoctors",
                column: "DoctorsId");

            migrationBuilder.CreateIndex(
                name: "IX_BookingUsers_UsersId",
                table: "BookingUsers",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Observations_PrescriptionId",
                table: "Observations",
                column: "PrescriptionId");
